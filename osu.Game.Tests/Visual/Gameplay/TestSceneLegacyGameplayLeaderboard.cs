...
{
    public partial class TestSceneLegacyGameplayLeaderboard : OsuTestScene
    {
        private Box? blackBackground;
        private LegacyDrawableGameplayLeaderboard leaderboard = null!;
        ...
        public TestSceneLegacyGameplayLeaderboard()
        {
        ...
        public void TestLayoutWithManyScores()
        {
            ...
            AddUntilStep("wait for fill flow layout",
                () => leaderboard.ChildrenOfType<FillFlowContainer<LegacyDrawableGameplayLeaderboardScore>>().First().ScreenSpaceDrawQuad.Intersects(leaderboard.ScreenSpaceDrawQuad));

            AddUntilStep("wait for some scores not masked away",
                () => leaderboard.ChildrenOfType<LegacyDrawableGameplayLeaderboardScore>().Any(s => leaderboard.ScreenSpaceDrawQuad.Contains(s.ScreenSpaceDrawQuad.Centre)));
            ...
            AddStep("create leaderboard", () =>
            {
                ...
                Child = new DependencyProvidingContainer
                {
                    ...
                    Children = new Drawable[]
                    {
                        ...
                        leaderboard = new LegacyDrawableGameplayLeaderboard
                        {
