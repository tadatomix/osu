...
namespace osu.Game.Skinning
{
    public partial class LegacyDrawableGameplayLeaderboard : CompositeDrawable, ISerialisableDrawable
    {
        ...
        public LegacyDrawableGameplayLeaderboardScore? TrackedScore { get; private set; }
        ...
        public LegacyDrawableGameplayLeaderboard()
        {
            ...
            InternalChildren = new Drawable[]
            {
                scroll = new InputDisabledScrollContainer
                {
                    ...
                    Child = Flow = new FillFlowContainer<LegacyDrawableGameplayLeaderboardScore>
                    {
                        Alpha = 0f,
        ...
        protected virtual LegacyDrawableGameplayLeaderboardScore CreateLeaderboardScoreDrawable(GameplayLeaderboardScore score) =>
            new LegacyDrawableGameplayLeaderboardScore(score);
        ...
        protected override void Update()
        {
            ...
            Width = Math.Max(Width, Flow.X + LegacyDrawableGameplayLeaderboardScore.MIN_WIDTH);
            Height = Math.Max(Height, LegacyDrawableGameplayLeaderboardScore.PANEL_HEIGHT);
            ...
            const float panel_height = LegacyDrawableGameplayLeaderboardScore.PANEL_HEIGHT;
